...
export const projects = [
  ...
  {
    title: "Weather4U",
    subtitle: "Third-Party API and localStorage",
    description:
      "App uses third-party OpenWeather API to receive data for 5-Day weather forecast based on user city input.",
...
export const skills = [
  ...
  { name: "Node.js", img: "devicon-nodejs-plain" },
  { name: "GrpahQL", img: "devicon-graphql-plain" },
  { name: "Python", img: "devicon-python-plain" },
  {
    name: "AWS Cloud Services",
    img: "devicon-amazonwebservices-plain-wordmark",
  },
  { name: "MongoDB", img: "devicon-mongodb-plain" },
  { name: "Heroku", img: "devicon-heroku-original" },
  { name: "Sequalize", img: "devicon-sequelize-plain" },
];
